...
let handle_get_read_ts_simple_last id n func => {
  ...
  | ["filter", t, "equals", v] => Json (read_last_apply (equals t v) !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "sum"] => Json (read_last_apply2 (equals t v) sum !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "count"] => Json (read_last_apply2 (equals t v) count !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "min"] => Json (read_last_apply2 (equals t v) min !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "max"] => Json (read_last_apply2 (equals t v) max !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "mean"] => Json (read_last_apply2 (equals t v) mean !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "median"] => Json (read_last_apply2 (equals t v) median !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "sd"] => Json (read_last_apply2 (equals t v) sd !ts_simple_json_store id (int_of_string n));
  | _ => Empty;
  };  
};
...
let handle_get_read_ts_simple_first id n func => {
  ...
  | ["filter", t, "equals", v] => Json (read_first_apply (equals t v) !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "sum"] => Json (read_first_apply2 (equals t v) sum !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "count"] => Json (read_first_apply2 (equals t v) count !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "min"] => Json (read_first_apply2 (equals t v) min !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "max"] => Json (read_first_apply2 (equals t v) max !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "mean"] => Json (read_first_apply2 (equals t v) mean !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "median"] => Json (read_first_apply2 (equals t v) median !ts_simple_json_store id (int_of_string n));
  | ["filter", t, "equals", v, "sd"] => Json (read_first_apply2 (equals t v) sd !ts_simple_json_store id (int_of_string n));
  | _ => Empty;
  };    
};
