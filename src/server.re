...
let handle_get_read_ts_simple_last id n func => {
  ...
  | ["sum"] => Json (read_last_apply sum !ts_simple_json_store id (int_of_string n));
  | ["count"] => Json (read_last_apply count !ts_simple_json_store id (int_of_string n));
  | ["min"] => Json (read_last_apply min !ts_simple_json_store id (int_of_string n));
  | ["max"] => Json (read_last_apply max !ts_simple_json_store id (int_of_string n));
  | ["mean"] => Json (read_last_apply mean !ts_simple_json_store id (int_of_string n));
  ...
  | ["filter", s1, "equals", s2, "max"] => Json (read_last_apply2 (equals s1 s2) max !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "mean"] => Json (read_last_apply2 (equals s1 s2) mean !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "median"] => Json (read_last_apply2 (equals s1 s2) median !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "sd"] => Json (read_last_apply2 (equals s1 s2) sd !ts_simple_json_store id (int_of_string n));
  | _ => Empty;
  };  
};
...
let handle_get_read_ts_simple_first id n func => {
  ...
  open Filter;
  switch func {
  | [] => Json (read_first !ts_simple_json_store id (int_of_string n));
  | ["sum"] => Json (read_first_apply sum !ts_simple_json_store id (int_of_string n));
  | ["count"] => Json (read_first_apply count !ts_simple_json_store id (int_of_string n));
  | ["min"] => Json (read_first_apply min !ts_simple_json_store id (int_of_string n));
  | ["max"] => Json (read_first_apply max !ts_simple_json_store id (int_of_string n));
  | ["mean"] => Json (read_first_apply mean !ts_simple_json_store id (int_of_string n));
  | ["median"] => Json (read_first_apply median !ts_simple_json_store id (int_of_string n));
  | ["sd"] => Json (read_first_apply sd !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2] => Json (read_first_apply (equals s1 s2) !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "sum"] => Json (read_first_apply2 (equals s1 s2) sum !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "count"] => Json (read_first_apply2 (equals s1 s2) count !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "min"] => Json (read_first_apply2 (equals s1 s2) min !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "max"] => Json (read_first_apply2 (equals s1 s2) max !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "mean"] => Json (read_first_apply2 (equals s1 s2) mean !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "median"] => Json (read_first_apply2 (equals s1 s2) median !ts_simple_json_store id (int_of_string n));
  | ["filter", s1, "equals", s2, "sd"] => Json (read_first_apply2 (equals s1 s2) sd !ts_simple_json_store id (int_of_string n));
  | _ => Empty;
  };    
};
...
let handle_get_read_ts_simple_since id t func => {
  ...
  | ["filter", s1, "equals", s2] => Json (read_since_apply (equals s1 s2) !ts_simple_json_store id (int_of_string t));
  | ["filter", s1, "equals", s2, "sum"] => Json (read_since_apply2 (equals s1 s2) sum !ts_simple_json_store id (int_of_string t));
  | ["filter", s1, "equals", s2, "count"] => Json (read_since_apply2 (equals s1 s2) count !ts_simple_json_store id (int_of_string t));
  | ["filter", s1, "equals", s2, "min"] => Json (read_since_apply2 (equals s1 s2) min !ts_simple_json_store id (int_of_string t));
  | ["filter", s1, "equals", s2, "max"] => Json (read_since_apply2 (equals s1 s2) max !ts_simple_json_store id (int_of_string t));
  | ["filter", s1, "equals", s2, "mean"] => Json (read_since_apply2 (equals s1 s2) mean !ts_simple_json_store id (int_of_string t));
  | ["filter", s1, "equals", s2, "median"] => Json (read_since_apply2 (equals s1 s2) median !ts_simple_json_store id (int_of_string t));
  | ["filter", s1, "equals", s2, "sd"] => Json (read_since_apply2 (equals s1 s2) sd !ts_simple_json_store id (int_of_string t));
  | _ => Empty;
  };    
