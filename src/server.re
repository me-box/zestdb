...
let handle_get_read_ts_simple_first id n func => {
  ...
  | ["sum"] => Json (read_first_aggregate sum !ts_simple_json_store id (int_of_string n));
  | ["count"] => Json (read_first_aggregate count !ts_simple_json_store id (int_of_string n));
