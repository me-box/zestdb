...
let read_lasts ctx::branch id_list::id_list n::n fn::fn => {
  Timeseries.read_lasts ctx::branch id_list::id_list n::n >>= apply fn;
};
...
let read_latests ctx::branch id_list::id_list fn::fn => {
  Timeseries.read_latests ctx::branch id_list::id_list >>= apply fn;
};
...
let read_earliests ctx::branch id_list::id_list fn::fn => {
  Timeseries.read_earliests ctx::branch id_list::id_list >>= apply fn;
};
...
let read_sinces ctx::ctx id_list::id_list from::ts fn::fn => {
  Timeseries.read_sinces ctx::ctx id_list::id_list from::ts >>= apply fn;
};
